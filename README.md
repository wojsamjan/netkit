...
2. Download: ```the Netkit "core", the Netkit filesystem, the Netkit kernel``` the [Latest Stable Release (http://wiki.netkit.org/index.php/Download_Official#Latest_Stable_Release)
